...
namespace KKS
{
    ...
    public abstract class KerbalKrashSystem : Damageable
    {
        ...
        /// <summary>
        /// ID of the ShieldCharge resource
        /// </summary>
        PartResourceDefinition ShieldCharge = PartResourceLibrary.Instance.GetDefinition("ShieldCharge");

        /// <summary>
        /// Visible shield duration (saturation), 0-1
        /// </summary>
        public float shieldVisible = 0;
        #endregion
        #endregion
        ...
        public void SetHighlighting()
        {
            ...
            {
                part.SetHighlightColor(new Color((float)0.0, (float)1.0, (float)1.0, shieldVisible));
